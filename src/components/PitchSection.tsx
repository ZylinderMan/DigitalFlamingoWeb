...
export default function PitchSection() {
  ...
  return (
    <section className="min-h-screen w-full flex items-center px-6 py-24">
      <div className="max-w-5xl mx-auto w-full flex flex-col md:flex-row items-center gap-12 md:gap-8">
        {/* Left: text */}
        <div className="flex-1 flex flex-col items-end text-right md:max-w-sm">
          <motion.h2
            key={t.pitch.heading}
            ...
            className="flex flex-wrap justify-end gap-x-3 text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-snug"
          >
            {words.map((word, i) => (
